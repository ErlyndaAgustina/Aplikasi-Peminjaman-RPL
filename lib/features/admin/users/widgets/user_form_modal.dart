              ...
              child: Column(
                ...
                children: [
                  ...
                  if (!isEdit) ...[
                    const SizedBox(height: 12),
                    _label("Password *"),
                    _textField(TextEditingController(), "••••••••••••", isPassword: true),
                  ],
                  const SizedBox(height: 12),
                  _label("Role"),
                  _dropdownRole(),
            ...
            onPressed: () {
              if (nameController.text.isNotEmpty && emailController.text.isNotEmpty) {
                widget.onSave(UserModel(
                  initials: nameController.text.substring(0, 2).toUpperCase(),
                  name: nameController.text,
                  email: emailController.text,
                  role: selectedRole == "Pilih Role" ? "Peminjam" : selectedRole,
                ));
